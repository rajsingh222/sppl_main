...
try {
    ...
    $stmt = $pdo->prepare("SELECT others_lt_reports FROM projects WHERE id = ?");
    ...
    $existingReports = json_decode($project['others_lt_reports'], true);
