...
try {
    ...
    $stmt = $pdo->prepare("SELECT sppl_lt_reports FROM projects WHERE id = ?");
    ...
    $existingReports = json_decode($project['sppl_lt_reports'], true);
