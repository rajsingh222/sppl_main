...
try {
    ...
    $stmt = $pdo->prepare("SELECT sppl_nde_reports FROM projects WHERE id = ?");
    ...
    $existingReports = json_decode($project['sppl_nde_reports'], true);
